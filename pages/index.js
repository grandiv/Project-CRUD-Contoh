...
export default function Beranda() {
  ...
  const handleSubmit = (e) => {
    ...
    setTodos([...todos, {id: Date.now(), title, desc}]) /*ketika submit, akan memanggil fungsi handleSubmit, bakal ngeset todos menjadi todo2 yang sudah ada + todo yang baru yang terdiri atas id utk spesifikasi, title, dan desc*/
  ...
  return (
    <>
      ...
      <div className="flex flex-col items-center justify-center m-[30px]">
        <h1 className="text-[30px] text-center font-bold">To Dos</h1>
